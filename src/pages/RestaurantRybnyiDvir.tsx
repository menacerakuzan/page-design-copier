      ...
      <section className="px-4 pb-12 pt-10 md:px-10">
        ...
        >
          ...
          <p className="mt-4 text-[24px] text-[#fff2e8]/90 font-odesa-regular">
            Ресторан <span className="mx-2 text-[#df9b3b]">•</span> Білгород-Дністровський
          </p>
        </motion.div>
      </section>
            ...
            <div className="rounded-[24px] bg-[#30557e] p-7">
              ...
              <div className="mt-5 space-y-3 text-[26px] leading-[1.2] font-odesa-regular">
                <p className="flex items-center gap-3">
                  <Clock3 className="h-6 w-6 text-[#df9b3b]" />
                  Пн - Чт: 09:00 - 22:00
                </p>
              ...
              <button
                type="button"
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#9f1f47] px-6 py-3 text-[22px] font-odesa-medium transition-colors hover:bg-[#ba2c5a]"
              >
                Забронювати <ArrowRight className="h-5 w-5" />
              </button>
            </div>

            <div ref={setSectionRef("contacts")} id="contacts" className="scroll-mt-24 rounded-[24px] bg-[#30557e] p-7">
