  ...
  <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
    ...
    <Link to={objectDetailPath(obj.type, obj.slug)}
      ...
      <div className="relative h-[170px] overflow-hidden xs:h-[198px]">
        ...
        <span className="absolute left-3 top-3 max-w-[calc(100%-24px)] truncate rounded-full px-3 py-1 text-[11px] font-odesa-medium uppercase tracking-wide text-white backdrop-blur-sm"
      ...
      <div className="relative p-3.5">
        ...
        {obj.subtitle && (
          <p className="mt-1 text-[13px] text-[#002f5e]/70 font-odesa-regular line-clamp-1">{obj.subtitle}</p>
        )}
        {obj.address && (
          <p className="mt-1.5 flex items-center gap-1.5 text-[13px] text-[#002f5e]/70 font-odesa-regular">
